  ...
  lazy val dist = (
    ...
    settings(
      ...
      localRepoArtifacts ++= Seq(
        ...
        Defaults.sbtPluginExtra("com.typesafe.play" % "sbt-plugin" % "2.5.4", "0.13", "2.10"),
        ...
        "com.typesafe.play" % "play-java_2.11" % "2.5.4",
        "com.typesafe.play" % "play-netty-server_2.11" % "2.5.4",
        "com.typesafe.play" % "play-logback_2.11" % "2.5.4",
        "com.typesafe.play" % "play-java-jdbc_2.11" % "2.5.4",
        "com.typesafe.play" % "play-cache_2.11" % "2.5.4",
        "com.typesafe.play" % "play-java-ws_2.11" % "2.5.4",
        "com.typesafe.play" % "play-test_2.11" % "2.5.4",
        "com.typesafe.play" % "play-omnidoc_2.11" % "2.5.4",
